...
$codeU = $_SESSION['code'];
$query = "SELECT * FROM ARTIGO WHERE CATEGORIA_ARTIGO = '$tipoMateria' ORDER BY DATA_ARTIGO ASC";
$total_reg = 5;
...
$tp = $tr / $total_reg;
if($tr == 0){
    echo "<p class='semUsuario'> Nenhuma Matéria Encontrada </p>";
}
else{
...
{         
    ...
    echo "<form id='usuariosA' action='opcoes.php' method='post'>";
        ...
        echo "<td><input type='submit' class='botoes2' name='editar' value='Editar Matéira'></td>";
        echo "<td><input type='submit' class='botoes2' name='excluir' value='Excluir Matéira'></td>";
